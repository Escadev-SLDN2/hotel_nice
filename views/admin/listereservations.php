			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="<?php echo SITE_DIR; ?>admin/editreservations/<?php echo $reserv['id']; ?>"><i class="fas fa-edit"></i></a>
						<a href="<?php echo SITE_DIR; ?>admin/supprimereservations/<?php echo $reserv['id']; ?>"><i class="fas fa-trash"></i></a></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
